...
public class YemekDB {
	...
	private String columns[] = { MySQLiteOpenHelper.COLUMN_DATE,MySQLiteOpenHelper.COLUMN_BIR,MySQLiteOpenHelper.COLUMN_IKI,
			MySQLiteOpenHelper.COLUMN_UC,MySQLiteOpenHelper.COLUMN_DORT,MySQLiteOpenHelper.COLUMN_CAL };
	...
	public long add(String gun,String bir,String iki,String uc,String dort, String cal){
		...
		values.put(MySQLiteOpenHelper.COLUMN_CAL,cal);
	...
	public Cursor getYemek(String tarih){
		Cursor c = database.query(MySQLiteOpenHelper.TABLE_NAME, columns, "gun="+tarih, null, null, null, null);
		return c;
	}
